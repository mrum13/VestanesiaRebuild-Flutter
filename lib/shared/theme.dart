...
Color kPrimaryColor = Color(0xff168039);
Color kWhiteColor = Color(0xffffffff);
Color kBlackColor = Color(0xff00261C);
Color kOrangeColor = Color(0xffF2994A);
Color kRedColor = Color(0xffF25656);
Color kSecondBlackColor = Color(0xff494949);
...
TextStyle orangeTextStyle = GoogleFonts.inter(color: kOrangeColor);
TextStyle redTextStyle = GoogleFonts.inter(color: kRedColor);
TextStyle secondBlackTextStyle = GoogleFonts.inter(color: kSecondBlackColor);
